...
import { CheckCircle2, Twitter, ExternalLink, Users, AlertCircle } from 'lucide-react';
...
export const TweetVerification = ({ onVerified, isVerified, disabled }: TweetVerificationProps) => {
  ...
  return (
    <Card className="cyber-border bg-cyber-dark/50 backdrop-blur-sm">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Required Hashtags */}
        <div>
          <Label className="text-cyber-light mb-2 block">Required Hashtags (use at least one):</Label>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-cyber-light/60 text-center">
            This will open Twitter with a pre-filled tweet. Feel free to modify it!
          </p>
        </div>
        ...
        {/* Friends Count */}
        <div className="space-y-2">
          <Label htmlFor="friends-count" className="text-cyber-light flex items-center">
